...
class ObjectUrlMixin(object):
    ...
    def get_absolute_url(self):
        ...
        """
        return CYDNS_BASE_URL + "/{0}/{1}/".format(
    ...
    def get_edit_url(self):
        ...
        """
        return CYDNS_BASE_URL + "/{0}/{1}/update/".format(
            self._meta.db_table, self.pk
        )
    ...
    def get_delete_url(self):
        ...
        """
        return CYDNS_BASE_URL + "/{0}/{1}/delete/".format(
            self._meta.db_table, self.pk
        )
    ...
    def get_create_url(self):
        ...
        """
        return CYDNS_BASE_URL + "/{0}/create/".format(self._meta.db_table)
