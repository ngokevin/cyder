...
class SimpleTest(TestCase):
    ...
    def test_ipv6_str(self):
        ...
        rd = ReverseDomain(name='128', ip_type='6')
    ...
    def test_creation(self):
        ...
        try:
            Ip( ip_str = "130.193.1.2" ) # Forget the ip_type
        ...
        ip.clean()
        self.assertTrue( ip.ip_upper and ip.ip_lower and ip.reverse_domain )
