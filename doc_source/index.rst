...
cyder is an `IPAM <http://en.wikipedia.org/wiki/Internet_Protocol_Address_Management/>`_ system. It is split up into two logically separate apps; `cydns` (DNS) and
